                ...
                <div class="row">
                    <div class="col-lg-5">
                        <form class="offset-3 col-6" action="index.php" method="get">
                            ...
                            <input type="radio" name="restaurante" value="1" <?php if ($bodega[6] == 1) {
    echo "checked='checked'";
}?>>Si<br>
                            <input type="radio" name="restaurante" value="0" <?php if ($bodega[6] == 0) {
    echo "checked='checked'";
}?>>No<br><br>
                            ¿Tiene hotel?<br>
                            <input type="radio" name="hotel" value="1" <?php if ($bodega[7] == 1) {
    echo "checked='checked'";
}?>>Si<br>
                            ...
                            <tbody>
                                ...
                                foreach ($vinos as $key => $value) {
                                    ...
                                    echo "<td class='container' style='width: 45%;'><div class='row' style='justify-content: space-evenly;'><form class='col-2' action='index.php' method='get'>
                                            <button class='btn btn-default' name='ver' value='", $value->getID(), "'>Ver</button>
                                            <input type='text' name='controller' value='vino' class='d-none'>
                                            <input type='text' name='volverVino' value='", $bodega[8],"' class='d-none'>
                                            </form>";
                                    echo "<form class='col-6' action='index.php' method='get'>
                                            <button type='submit' class='btn btn-danger' name='eliminar' value='", $value->getID(), "'>Eliminar</button>
                                            <input type='text' name='controller' value='vino' class='d-none'>
                                            <input type='text' name='action' value='eliminar' class='d-none'>
                                            <input type='text' name='ver' value='", $_GET["ver"],"' class='d-none'>
                                            </form></div></td>";
                                    echo "</tr>";
                                }
                                ?>
